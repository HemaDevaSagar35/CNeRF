...
class Generator(nn.Module):
    ...
    def forward(self, styles, cam_poses, focals, near=0.88, far=1.12, return_latents=False,
        ...
        with torch.set_grad_enabled(self.is_train and self.train_renderer):
            ...
            thumb_rgb, features, sdf, mask, xyz, eikonal_term, seg, rgb_sem = self.renderer(cam_poses, focals, near, far, styles=latent, return_eikonal=return_eikonal, semantics=semantics)
