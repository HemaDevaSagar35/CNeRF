...
class BaseOptions():
    ...
    def initialize(self):
        ...
        dataset.add_argument("--dataset_path", type=str, default='drive/MyDrive/FFHQ_dataset', help="path to the lmdb dataset")
        ...
        training.add_argument("--checkpoints_dir", type=str, default='drive/MyDrive/orignal/checkpoints', help='checkpoints directory name')
        ...
        training.add_argument("--iter", type=int, default=1, help="total number of training iterations")
        ...
        training.add_argument("--chunk", type=int, default=1, help='number of samples within a batch to processed in parallel, decrease if running out of memory')
        ...
        model.add_argument("--n_wcode", type=int, default=12, help="the number of semantic mask")
        ...
        rendering.add_argument("--n_render", type=int, default=12, help="the number of local semantic 3d generator")
