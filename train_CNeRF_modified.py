...
if __name__ == "__main__":
    ...
    loader, _ = datasets.get_dataset_distributed(
        'FFHQDataset',
        opt.training.batch,
        distributed=opt.training.distributed,
        shuffle=True,
        dataset_path = opt.dataset.dataset_path,
        img_size = 64,
